...
#-2 is the second to the last letter
...
print(text[0:5]) # print hello
print(text[2:5]) #print"llo"
print(text [-1])#print "!"
print(text[;;-1])# print"dlrow,olleH"
text = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
print(text[0:-1:2])# print "Hlo ol"
#this skips every 2nd letter 
print (text[0-1:3])
# Get the substring CDE and put in a variable
sumstring=text.find ("CDE")
print(sumstring)#prints 2 which is the idex of C
substring=text[2:5]
print(substring)#print cde
#print RST
substring= text.find("RST")
print(substring)#print 17 which is the index of R
substring=text[17:20]
print(substring)#print RST 
...
#upercasethe text 
sentence="especially in electronic communications ,weitting in all caps is equivalent to yelling"
print(sentence.upper()) #prints the sentence in upercase letters
sentence2="SIMPLE IS ALWAYS BETTER THEN COMPLEX"
print(sentence2.lower())#prints the sentence in lowercase letters
substring=text.find  ("communications") #prints 26
#upercase the word"communications"
print(sentence[26:38].upper()) #prints COMMUNICATIONS

# join the following list into a string 
#seperating each item with a space 
word_list=["siomple","is","better","then","complex"]
joined_list="".join(word_list) #print simple is better then complex
...
#split the sentence to the left 
split_sentence =sentence .split()
print(split_sentence)#print [If","the","implematation","is"]
#this will split the sentence into a list of words
sentence3="try to be a rainbow in someones cloud"
split_sentence3= sentence.split ("try,")
print(split_sentence3) # prints ['try','to',be','a','rainbow','in']

#replace the word "hard" with 'easy' and 'bad' with 'good'
sentence4="if the implemation is to hard to explain, it might be bad idea"
new_sentence=sentence4.replace ('hard','easy').replace("bad","good")
print(new_sentence)#prints "if the implemation is easy to explain ,it might be a good idea "
# concreate the text repeat 15 times 
